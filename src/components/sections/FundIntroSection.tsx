				...
				<TextContent>
					...
					<div className="description">
						<StorySection>
							...
							<p>
								평소 고아 청년들의 자립에 관심이 많으신 경남 지역 모 교회 권사님이 계셨습니다. <br />
								권사님께서는 자신의 집에 방들을 수리하여 원에서 나오는 청년들이 묵을 거처를 마련하기도 했지만 <br />
								청년들이 독립적인 공간을 원한다는 소식을 듣고 어떻게 해야 하나 고민하며 기도하고 계셨습니다. 
								<br /><br />
								그러던 찰나에 부산지역의 한 교회에서 사역하던 목회자를 만났습니다. 이 목회자는 권사님께서 섬기시는 한 때 교회의 부교역자로 사역했었습니다. <br />
								이 목회자가 사역지를 다른 교회로 옮긴 이후에도 가끔 권사님을 만나 교제를 하고 하나님의 나라 확장을 위해 함께 기도하곤 했었습니다. <br />
								권사님을 만난 목회자는 자신이 사역하는 교회에 고아 청년들이 많다는 소식을 권사님께 하게 되었고, 이에 자신이 그동안 모아 놓으신 거의 전재산을 고아들의 자립을 위해 헌신하셨습니다. <br />
								권사님의 소중한 헌신으로 442장미기금이 시작되었습니다.
							</p>
							<h3>442장미기금 명칭의 의미</h3>
							<p>
								권사님께서는 찬송가 442장 "황무지가 장미꽃 같이 피는 것을 볼 때에"를 사랑하고 자주 부르셨습니다. <br />
